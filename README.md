...
- Price Growth: K = 1.5 (x^1.5 curve)
- Max Supply: 1 billion tokens
- Bonding Curve Allocation: 400k tokens
- Max Single Buy: 1 ETH
- Default Graduation Target: 30 ETH
...
2. Remaining tokens + raised ETH create Uniswap V3 pool
3. Full-range liquidity position minted (owned by Diamond)
4. Excess tokens burned to dead address
